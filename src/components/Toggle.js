...
const Toggle = () => {
  ...
  return (
    <div className="flex container mx-auto justify-between md:max-w-[730px] md:max-h-[36px] mt-36 px-6 md:px-0">
      <h1>devfinder</h1>
      {theme === "dark" ? (
        <div
          className="flex items-center cursor-pointer font-bold text-[13px] tracking-[2.5px] text-btnText hover:text-btnTextHover"
          onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
        >
          LIGHT
          <svg className="fill-current ml-4" width="20" height="20">
